...
import Film from "./pages/film/index.tsx";
import Detail from "./pages/film/detail/index.tsx";
import Upload from "./pages/film/develop/upload/index.tsx";
import Edit from "./pages/film/develop/edit/index.tsx";
